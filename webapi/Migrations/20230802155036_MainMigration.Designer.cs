...
namespace webapi.Migrations
{
    ...
    [Migration("20230802155036_MainMigration")]
            ...
            modelBuilder.Entity("webapi.Models.Authentication", b =>
                {
                    ...
                    b.ToTable("Authentication", "userMGT");
                });
            ...
            modelBuilder.Entity("webapi.Models.Staff", b =>
                {
                    b.HasOne("webapi.Models.User", "User")
                        .WithOne("Staff")
                        .HasForeignKey("webapi.Models.Staff", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
